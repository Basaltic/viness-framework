...
export const DashboardPage1RouteId = registerRoute({ path: 'page1', Component: DashboardPage1 })
...
export const routes: RouteItem[] = [
    ...
    {
        id: DashboardRouteId,
        children: [{ id: DashboardPage1RouteId }, { id: DashboardPage2RouteId }, { id: DashboardPage3Route }]
    }
]

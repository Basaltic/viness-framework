...
import { createDecorator as createDecoratorOriginal } from '../ioc/create-decorator';
import { createWire as createWireOriginal } from '../ioc/create-wire';
import { createResolve as createResolveOriginal } from '../ioc/create-resolve';

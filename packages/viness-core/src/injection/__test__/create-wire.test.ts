...
import { NOCACHE } from '../ioc/tags';
import { token } from '../ioc/token';

import { createWire } from '../ioc/create-wire';
...
class ctorArgumentsWireTest {
    ...
    constructor() {
        wire<OneArg, this, 'oneArg', ConstructorParameters<typeof OneArg>>(this, 'oneArg', TYPE.oneArg, [], 'with one arg');
